...
const Footer = ({ className = '' }) => {
  ...
  const footerLinks = {
    product: [
      { label: 'Browse Notes', path: '/notes' },
      { label: 'AI Assistant', path: '/summary' },
  ...
  return (
    <footer className={`bg-[var(--color-bg-secondary)] border-t border-[var(--border-color)] ${className}`}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-[var(--color-text-secondary)] mb-4">
              Your intelligent academic companion. Upload notes, learn smarter with AI assistance.
            </p>
            {/* Social Links */}
        ...
        <div className="mt-12 pt-8 border-t border-[var(--border-color)]">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-[var(--color-text-muted)]">
              © {currentYear} PathshalaAI. All rights reserved.
            </p>
            <p className="text-sm text-[var(--color-text-muted)]">
